document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      alert('Thank you for your inquiry! We will contact you shortly to confirm your consultation.');
      contactForm.reset();
    });
  }
});
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Dror Lahav - Jewelry Design uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '87da2e74-ad46-434e-a127-1ddc720154e5',
                    name: data.name || '',
                    email: data.email || '',
